...
sixtop_statemachine = {
   ...
   7: "WAIT_QUERYREQUEST_SENDDONE",
   8: "WAIT_ADDRESPONSE",
   9: "WAIT_DELETERESPONSE",
  10: "WAIT_RELOCATERESPONSE",
  11: "WAIT_COUNTRESPONSE",
  12: "WAIT_LISTRESPONSE",
  13: "WAIT_CLEARRESPONSE",
}
